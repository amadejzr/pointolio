...
/// Notebook/Slate delete confirmation. Crosses the party name out (like
/// striking an entry from the book) and asks to confirm. Returns true if the
/// user confirmed deletion.
Future<bool> showDeletePartyDialog(
  ...
  final confirmed = await showDialog<bool>(
    ...
    builder: (_) => _DeletePartyDialog(partyName: partyName),
  );
  return confirmed ?? false;
}

class _DeletePartyDialog extends StatelessWidget {
  const _DeletePartyDialog({required this.partyName});
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'This party and all its scores are gone for good.',
