...
/// Actions offered by the per-party "⋯" dropdown.
enum PartyAction { toggleFinished, delete }
...
/// returns the chosen [PartyAction], or null if dismissed. Fully custom (no
/// Material popup) so it matches the Notebook/Slate surfaces and motion.
Future<PartyAction?> showPartyMenu(
  ...
  return showGeneralDialog<PartyAction>(
          ...
          Positioned(
            ...
            child: FadeTransition(
              ...
              child: ScaleTransition(
                ...
                child: _PartyMenu(isFinished: isFinished),
              ),
            ),
          ),
        ],
...
class _PartyMenu extends StatelessWidget {
  const _PartyMenu({required this.isFinished});
        ...
        child: Column(
          ...
          children: [
            _MenuRow(
              ...
              label: isFinished ? 'Reopen party' : 'Mark as finished',
              color: pt.accent,
              tint: pt.accentTint,
              textColor: pt.text,
              onTap: () => Navigator.pop(context, PartyAction.toggleFinished),
            ),
            Divider(
              height: 1,
              thickness: 1,
            ...
            _MenuRow(
              ...
              onTap: () => Navigator.pop(context, PartyAction.delete),
            ),
          ],
        ),
      ),
