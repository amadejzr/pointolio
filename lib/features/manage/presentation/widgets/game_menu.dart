...
/// Actions offered by the per-game "⋯" dropdown.
enum GameAction { edit, delete }
...
/// returns the chosen [GameAction], or null if dismissed. Mirrors the Parties
/// per-item menu so the Notebook/Slate surfaces and motion stay consistent.
Future<GameAction?> showGameMenu(BuildContext anchorContext) {
  ...
  return showGeneralDialog<GameAction>(
        ...
        child: Column(
          ...
          children: [
            _MenuRow(
              ...
              tint: pt.accentTint,
              textColor: pt.text,
              onTap: () => Navigator.pop(context, GameAction.edit),
            ),
            Divider(
              height: 1,
              thickness: 1,
            ...
            _MenuRow(
              ...
              onTap: () => Navigator.pop(context, GameAction.delete),
            ),
          ],
        ),
      ),
