...
/// Notebook/Slate delete confirmation for a player. Crosses the name out (like
...
Future<bool> showDeletePlayerDialog(
  ...
  final confirmed = await showDialog<bool>(
    ...
    builder: (_) => _DeletePlayerDialog(playerName: playerName),
  );
  return confirmed ?? false;
}

class _DeletePlayerDialog extends StatelessWidget {
  const _DeletePlayerDialog({required this.playerName});
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // The player name, struck through like a deleted entry.
                Text(
                  playerName,
                  maxLines: 2,
                ...
                Text(
                  'This player will be removed for good.',
